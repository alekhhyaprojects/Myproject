...
const Viralscientific = () => {
  ...
  return (
    <div className="Viral_scientific_container">
    <div className="Viral_scientific_background_container">
      <h1>Virology and Vaccine Development Forumn</h1>
      <p>Trending research Scientific topics</p>
    </div>

    <div className="Viral_scientific_content_container">
      <h2 className="Viral_scientific_heading">Trending research Virology and Antiviral Therapy and Drug Development-Scientific topics..</h2>
      <p>Here are a few trending topics in Virology Antiviral Therapy and Drug Development</p>
      <div className="Viral_scientific_topic-rows">
        <ul className="Viral_scientific_topic-list">
          {topics.map((topic, index) => (
            <li key={index} className="Viral_scientific_topic-item">
              <div onClick={() => handleTopicClick(index)} className="Viral_scientific_topic-title">
                <FaMicrophone className="Viral_scientific_icon" /> {topic.title}
              </div>
              {selectedTopic === index && (
                <p className="Viral_scientific_topic-content">{topic.content}</p>
              )}
            </li>
          ))}
        </ul>
        ...
        <ul className="Viral_scientific_topic-list">
          {topics2.map((topic, index) => (
            <li key={index} className="Viral_scientific_topic-item">
              <div onClick={() => handleTopicClick(index + topics.length)} className="Viral_scientific_topic-title">
                <FaMicrophone className="Viral_scientific_icon" /> {topic.title}
              </div>
...
export default Viralscientific