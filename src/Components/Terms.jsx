    ...
    <div className='terms-container'>
      ...
      <div className='terms-2'>
        ...
        <ul>
          ...
          <li><strong>Company</strong> (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to Stripe Conferences, Palo Alto, California 94303, United States.</li>
          ...
          <li><strong>Website</strong> refers to Stripe Conferences, accessible from.</li>
        ...
        <p>These Terms and Conditions apply to all visitors, users, and others who access or use the Service.</p>
        ...
        <ul>
          <li>By email: support@stripeconferences.com</li>
          <li>By visiting this page on our website: https://www.stripeconferences.com/stripe-conferences-contact-us/</li>
          <li>By phone number: +1 630 259 0521</li>
        </ul>

        <h2>Locations</h2>
        <p>Stripe Conferences Inc</p>
        <p>16192 Coastal Highway Lewes, Delaware, USA 19958</p>
        <p>Symposyo Events Private Limited</p>
        <p>Unit 704C PSR Prime Towers Gachibowli, Hyderabad, Telangana, India 500032</p>
      </div>
    </div>
  );
}
