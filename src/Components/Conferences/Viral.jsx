...
const Viral = () => {
  ...
  return (
    <>
    <div>
       <div className='viral-background-container'>
        <div className='viral-V-text'>
        <p>August 11-12, 2025 | Toronto, Canada</p>
        <h2>International Conference on</h2>
        <h1>Public Health and Viral Epidemiology2025</h1>
        <p>Theme: “Advancing Public Health Through Innovative Viral Epidemiology: 2025 and Beyond”</p>
        </div>
        <div className='viral-summitbuttons'>
          <button><Link to="/Viralabstract">SUMMIT ABSTRACT</Link></button>
...
<h1 className='viral-V-h'>Innovation-Driven Research</h1>


<div className="viral-infosection">
      {/* Section row with onClick functions */}
      <div className="viral-info-section-row">
      ...
      <div className="viral-info-section">
    ...
    <div className="viral-scientific-sessions-container">
      ...
      <div className="viral-topics-grid">
        {/* Left Column */}
        <div className="viral-topics-column">
          <div className="viral-topic-item">
            <TiTick className="tick-icon" />
            <p>Bacterial Infectious Diseases</p>
          </div>
          <div className="viral-topic-item">
            <TiTick className="viral-tick-icon" />
      ...
      <button className='viral-scientificbutton'><Link to="/Viralscientific">view all scientific sessions</Link></button>
</div>


<div>
  <div className='viral-registrationtext'>
  ...
  <h1 className='viral-V-h'>REGISTRATION</h1>
  <div className='viral-registration-boxes'>

    <div className='viral-registrationbox'>
      <div className='viral-inner-box'>
...
<div>
  <div class="viral-registrationtext">
  <h1 className='viral-V-h'>Get In Touch</h1>
  ...
  <div className='viral-registration-boxes2'>

    <div className='viral-registrationbox2'>
      <div className='viral-inner-box2'>
  ...
  <div className='viral-m-media'>
  <h1 className='viral-m-Mediahead'>Media Patner's</h1>
  <div className='viral-m-Mediacontainer'>
   ...
   <div className='viral-m-Mediabox1'>
...
<div className='viral-venue'>
  <div className='viral-venuetext'>
   <h1>Venue</h1>
...
<div className='viral-contact-form-section'>
    <form className='viral-form' onSubmit={handleSubmit}>
      <h1 className='viral-V-h'>CONTACT US</h1>
