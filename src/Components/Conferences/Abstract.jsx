      ...
      <div className='abstract-container'>
        <div className='abstract-text'>
          ...
          <div className='abstract-row'>
            ...
            <button className='abstract-button'>Download here</button>
          </div>
        </div>
      </div>
      ...
      <div className='abstract-form-row'>
        <div className='abstract-form-section'>
          <form className='form' onSubmit={handleSubmit}>
            ...
            <label htmlFor="abstract-session-option">Abstract Session:</label>
            <div className="abstract-select">
              <select
                id="abstract-session-option"
                className="select"
            ...
            <label htmlFor="abstract-type-option">Abstract Type:</label>
            <div className="abstract-select">
              <select
                id="abstract-type-option"
                className="select"
                value={selectedType}
            ...
            <button className='abstract-btn' type="submit">Submit</button>
          </form>
        </div>
