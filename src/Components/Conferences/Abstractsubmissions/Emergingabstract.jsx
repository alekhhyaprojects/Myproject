...
const Emergingabstract = () => {
  ...
  return (
    <>
      <div className='emerging-abstract-container'>
        <div className='emerging-abstract-text'>
          ...
          <div className='emerging-abstract-row'>
            <h2>Abstract Template</h2>
            <button className='emerging-abstract-button'>Download here</button>
          </div>
        </div>
      </div>

      <div className='emerging-abstract-form-row'>
        <div className='emerging-abstract-form-section'>
          <form className='form' onSubmit={handleSubmit}>
            ...
            <label htmlFor="emerging-abstract-session-option">Abstract Session:</label>
            <div className="emerging-abstract-select">
              <select
                id="emerging-abstract-session-option"
                className="select"
            ...
            <label htmlFor="emerging-abstract-type-option">Abstract Type:</label>
            <div className="emerging-abstract-select">
              <select
                id="emerging-abstract-type-option"
                className="select"
                value={selectedType}
            ...
            <button className='emerging-abstract-btn' type="submit">Submit</button>
          </form>
        </div>
...
export default Emergingabstract;