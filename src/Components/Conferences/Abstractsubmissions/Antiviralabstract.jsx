...
const Antiviralabstract = () => {
  ...
  return (
    <>
      <div className='Antiviral-abstract-container'>
        <div className='Antiviral-abstract-text'>
          <h1>Emerging Viral Diseases Abstract Submission Form</h1>
          <p>Feel free to let me know if there's anything else you need help with</p>
          <div className='Antiviral-abstract-row'>
            <h2>Abstract Template</h2>
            <button className='Antiviral-abstract-button'>Download here</button>
          </div>
        </div>
      </div>

      <div className='Antiviral-abstract-form-row'>
        <div className='Antiviral-abstract-form-section'>
          <form className='form' onSubmit={handleSubmit}>
            ...
            <label htmlFor="Antiviral-abstract-session-option">Abstract Session:</label>
            <div className="Antiviral-abstract-select">
              <select
                id="Antiviral-abstract-session-option"
                className="select"
            ...
            <label htmlFor="Antiviral-abstract-type-option">Abstract Type:</label>
            <div className="Antiviral-abstract-select">
              <select
                id="Antiviral-abstract-type-option"
                className="select"
                value={selectedType}
            ...
            <button className='Antiviral-abstract-btn' type="submit">Submit</button>
          </form>
        </div>
...
export default Antiviralabstract;