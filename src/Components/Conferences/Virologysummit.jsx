...
import './Virologysummit.css'
import { TiTick } from "react-icons/ti";
import { FaMicrophone } from "react-icons/fa6";
import { FaGraduationCap } from "react-icons/fa";
import { FaBusinessTime } from "react-icons/fa6";
const Virologysummit = () => {
...
<>
    ...
    <div>
       <div className='virology-summit-background-container'>
        <div className='virology-summit-v-text'>
        <h4>November 25 - 26, 2024 | Paris, France.</h4>
        <h1>International Virology Summit 2024</h1>
        <p>November 25 - 26, 2024 | Paris, France.International Virology Summit 2024</p>
        </div>
        <div className='virology-summit-summitbuttons'>
          <button><Link to="/Abstract">SUMMIT ABSTRACT</Link></button>
          <button><Link to="/Register">GO TO REGISTRATION</Link></button>
          <button><Link to="/Brochure">DOWNLOAD BROCHURE</Link></button>
          <button>TENTATIVE PROGRAM</button>
        </div>
      </div>
</div>

<h1 className='virology-summit-h'>Innovation-Driven Research</h1>


<div className="virology-summit-infosection">
      {/* Section row with onClick functions */}
      <div className="virology-summit-info-section-row">
      ...
      <div className="virology-summit-info-section">
        {/* General Info Section */}
        {selectedSection === "general-info" && (
          <p className="virology-summit-info-p">
    ...
    <div className="virology-summit-scientific-sessions-container">
      ...
      <div className="virology-summit-topics-grid">
        {/* Left Column */}
        <div className="virology-summit-topics-column">
          <div className="virology-summit-topic-item">
            <TiTick className="virology-summit-tick-icon" />
      ...
      <button className='virology-summit-scientificbutton'><Link to="/Summitscientific">view all scientific sessions</Link></button>
</div>


<div>
  <div className='virology-summit-registrationtext'>
  ...
  <h1 className='virology-summit-registration-heading'>REGISTRATION</h1>
  <div className='virology-summit-registration-boxes'>
    <div className='virology-summit-registrationbox'>
      <div className='virology-summit-inner-box'>
        <FaMicrophone className='virology-summit-boxicons' />
        <h4>Speaker</h4>
        <p>Early Bird Registration</p>
        <h3>$745</h3>
      </div>
      <button className='virology-summit-button'>Register now</button>
    </div>

  
    <div className='virology-summit-registrationbox'>
      <div className='virology-summit-inner-box'>
        <FaGraduationCap className='virology-summit-boxicons'/>
        <h4>Student</h4>
        <p>Early Bird</p>
        <h3>$395
        </h3>
    ...
    <div className='virology-summit-registrationbox'>
      <div className='virology-summit-inner-box'>
        <FaBusinessTime  className='virology-summit-boxicons' />
        <h4>Delegate</h4>
        <p>Early Bird</p>
        <h3>$795</h3>
      </div>
...
<div>
  <div className='virology-summit-Get-text'>
  <h1 className="virology-summit-h">Get In Touch</h1>
  ...
  <div className='virology-summit-registration-boxes2'>

    <div className='virology-summit-registrationbox2'>
      <div className='virology-summit-inner-box2'>
        <FaMicrophone className='virology-summit-boxicons2' />
        <h4>Address</h4>
    ...
    <div className='virology-summit-registrationbox2'>
      <div className='virology-summit-inner-box2'>
        <FaGraduationCap className='virology-summit-boxicons2'/>
        <h4>Phone number</h4>
        <p>+1 424 382 0198</p>
      </div>
    </div>
    ...
    <div className='virology-summit-registrationbox2'>
      <div className='virology-summit-inner-box2'>
        <FaBusinessTime  className='virology-summit-boxicons2' />
 ...
 <div className='virology-summit-m-media'>
  <h1 className='virology-summit-m-Mediahead'>Media Patner's</h1>
  <div className='virology-summit-m-Mediacontainer'>
   <div className='virology-summit-m-Mediabox1'>
   <img src="https://th.bing.com/th/id/OIP.dvp1KVtUjM7dPTR5dPEsRgAAAA?rs=1&pid=ImgDetMain" alt="img" className='virology-summit-M-boximg' />
   </div>
   <div className='virology-summit-m-Mediabox1'>
   <img src="https://i0.wp.com/blog.10times.com/wp-content/uploads/2019/09/cropped-10times-logo-hd.png?fit=3077%2C937&ssl=1" alt="img" className='virology-summit-M-boximg' />
   </div>
   <div className='virology-summit-m-Mediabox1'>
   <img src="https://d35w6hwqhdq0in.cloudfront.net/transform/compress/21e1bffc6a43c967299cad0a1a235c8f.png" alt="img" className='virology-summit-M-boximg' />
   </div>
   <div className='virology-summit-m-Mediabox1'>
   <img src="https://www.thequeenshall.net/sites/default/files/images/tradfest-colour.png" alt="img" className='virology-summit-M-boximg' />
   </div>
   <div className='virology-summit-m-Mediabox1'>
   <img src="https://www.biihealthtech.com/wp-content/uploads/2023/09/World-Conference-Alerts.jpg" alt="img" className='virology-summit-M-boximg' />
  </div>
   <div className='virology-summit-m-Mediabox1'>
   <img src="https://virologyevents.com/wp-content/uploads/2024/07/events-in-ammeric-1.webp" alt="img" className='virology-summit-M-boximg'/>
  </div>
 </div>
</div>

<div className='virology-summit-venue'>
  <div className='virology-summit-venuetext'>
   <h1>Venue</h1>
  ...
  <div className='virology-summit-venuemap'>
        <iframe 
...
<div className='virology-summit-contact-form-section'>
  <form className='virology-summit-form' onSubmit={handleSubmit}>
    <h1 className='virology-summit-h'>CONTACT US</h1>
    ...
    <textarea 
      ...
      onChange={handleChange} 
    />
    <button className='virology-summit-btn' type="submit">Submit</button>
  </form>
</div>
</>
  )
